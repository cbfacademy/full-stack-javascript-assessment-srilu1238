...
if (process.env.NODE_ENV === "production") {
  app.use(express.static(path.join(__dirname1, "/package/Sri-Chat-app/frontend/build")));

  app.get("*", (req, res) =>
    res.sendFile(path.resolve(__dirname1, "package","Sri-Chat-app","frontend", "build", "index.html"))
  );
} else {
  app.get("/", (req, res) => {
    res.send("API is running..");
