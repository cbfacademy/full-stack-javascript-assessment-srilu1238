...
io.on("connection", (socket) => {
  ...
  if (process.env.NODE_ENV === "production") {
    app.use(express.static("/opt/render / project / src / packages / Sri - Chat-app / backend / frontend / build "));

    app.get("*", (req, res) =>
      res.sendFile(path.resolve("/opt/render/project/src/packages/Sri-Chat-app/frontend/build/index.html"))
    );
  } else {
    app.get("/api", (req, res) => {
